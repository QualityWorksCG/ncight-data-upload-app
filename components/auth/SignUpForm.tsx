        ...
        <Stack spacing={2} maxW={"lg"}>
          ...
          <FormControl id="signup-password">
            ...
            <FormHelperText fontWeight="700" color="secondary.yellow">
              <CheckIcon color={"primary.gray"} /> 8 characters
            </FormHelperText>
            <FormHelperText fontWeight="700" color="secondary.yellow">
              <CheckIcon color={"primary.gray"} /> at least 1 uppercase letter
            </FormHelperText>
            <FormHelperText fontWeight="700" color="secondary.yellow">
              <CheckIcon color={"primary.gray"} /> at least 1 lowercase letter
            </FormHelperText>
            <FormHelperText fontWeight="700" color="secondary.yellow">
              <CheckIcon color={"primary.gray"} /> at least 1 special character
            </FormHelperText>
            <FormHelperText fontWeight="700" color="secondary.yellow">
              <CheckIcon color={"primary.gray"} /> at least 1 number
            </FormHelperText>
          </FormControl>
          <FormControl
