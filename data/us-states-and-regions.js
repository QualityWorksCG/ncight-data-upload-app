module.exports=[
    ...
    { label: 'Alaska (AK)', value: { state: 'Alaska', region: 'West' } },
    {
      label: 'Arizona (AZ)',
    ...
    { label: 'Hawaii (HI)', value: { state: 'Hawaii', region: 'West' } },
    { label: 'Idaho (ID)', value: { state: 'Idaho', region: 'West' } },
    {
      label: 'Illinois (IL)',
    ...
    { label: 'Iowa (IA)', value: { state: 'Iowa', region: 'Midwest' } },
    {
      label: 'Kansas (KS)',
    ...
    { label: 'Ohio (OH)', value: { state: 'Ohio', region: 'Midwest' } },
    {
      label: 'Oklahoma (OK)',
      value: { state: 'Oklahoma', region: 'Southwest' }
    },
    { label: 'Oregon (OR)', value: { state: 'Oregon', region: 'West' } },
    {
    ...
    { label: 'Utah (UT)', value: { state: 'Utah', region: 'West' } },
    {
      label: 'Vermont (VT)',
