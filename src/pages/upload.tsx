...
import { GetUrlsAndUpload, UploadToAPI } from "../local-api/Upload";
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    files.map((file) => {
      uploadList.push({
        ...
        surgeryDate: new Date(values.dateOfSurgery).toISOString(),
